			...
			<div class="contact-form">
				<form id="contact-form" method="post" action="#">
					...
					<div class="contact-submit">
						...
						<input type="button" value="kembali" onclick="window.location='admin.php';" class="form-control submit"/>
					</div>
				</form>
			</div>
		</div>
